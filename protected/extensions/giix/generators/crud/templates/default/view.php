...
$this->menu=array(
    ...
    array('label'=>Yii::t('app','Update <?php echo $this->class2name($this->modelClass)?>'), 'url'=>array('update', 'id'=>$<?php echo $this->modelId?>-><?php echo $this->tableSchema->primaryKey; ?>)),
    array('label'=>Yii::t('app','Delete <?php echo $this->class2name($this->modelClass)?>'), 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$<?php echo $this->modelId?>-><?php echo $this->tableSchema->primaryKey; ?>),'confirm'=>'Are you sure you want to delete this item?')),
